...
namespace Perfect.Common.DS.dsSTOCKTableAdapters {
...
SELECT Stock_Name, Stock_ID, CAST(Active AS INT) AS ActiveInt FROM STOCK AS s WHERE (Stock_ID = @Stock_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Perfect.Common.Properties.Settings.Default.ERP_QLBH_2_9_1_4ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT s.Stock_Name,\r\n       s.Stock_ID,\r\n       CAST(s.[Active] AS INT) AS Activ" +
                "eInt\r\nFROM   STOCK s";
