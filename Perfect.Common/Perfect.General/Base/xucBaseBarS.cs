...
namespace Perfect.Common
{
    public partial class xucBaseBarS : xucBase
    {
        ...
        {
            get { return bbiMerrial.Checked; }
            set { bbiMerrial.Checked = value; }
        }

        public CheckButton Merrial
        {
            get { return bbiMerrial; }
            set { bbiMerrial = value; }
        }
        ...
        private void chxMerrial_CheckedChanged(object sender, EventArgs e)
        {
            RaiseViewChangedClickEventHander();
        }
