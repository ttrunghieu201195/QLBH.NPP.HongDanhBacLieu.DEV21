...
namespace Perfect.Common
{
    ...
    public partial class xucBaseXAdd : xucBase
    {
        public xucBaseXAdd()
        {
            InitializeComponent();
        ...
        {
            //CONTROL_FORMAT.Save("xucBaseXAdd");
        }

        protected virtual void SetInterface()
        {
            //DataTable dt = CONTROL_FORMAT.Load("xucBaseXAdd");
        ...
        public virtual void Save()
        {
            ...
            {
                XtraMessageBox.Show((txtID.ErrorText.Length == 0 ? "Dữ liệu của ô này không được bỏ trống." : txtID.ErrorText), "Thông báo");
                txtID.Focus();
            ...
            {
                XtraMessageBox.Show((txtNAME.ErrorText.Length == 0 ? "Dữ liệu của ô này không được bỏ trống." : txtNAME.ErrorText), "Thông báo");
                txtNAME.Focus();
                return;
            }
