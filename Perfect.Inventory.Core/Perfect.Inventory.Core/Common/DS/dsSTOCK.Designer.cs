...
namespace Perfect.Inventory.Core.Common.DS {
    ...
    public partial class dsSTOCK : global::System.Data.DataSet {
        ...
        public partial class STOCKDataTable : global::System.Data.TypedTableBase<STOCKRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public STOCKRow AddSTOCKRow(string Stock_Name, string Stock_ID, int ActiveInt) {
        ...
        public partial class STOCKRow : global::System.Data.DataRow {
            ...
            public int ActiveInt {
                get {
                    try {
                        return ((int)(this[this.tableSTOCK.ActiveIntColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ActiveInt\' in table \'STOCK\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableSTOCK.ActiveIntColumn] = value;
                }
            }
            ...
            public bool IsActiveIntNull() {
                return this.IsNull(this.tableSTOCK.ActiveIntColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetActiveIntNull() {
                this[this.tableSTOCK.ActiveIntColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Perfect.Inventory.Core.Common.DS.dsSTOCKTableAdapters {
    ...
    public partial class STOCKTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [STOCK] WHERE (((@IsNull_Stock_Name = 1 AND [Stock_Name] IS NULL) OR " +
                "([Stock_Name] = @Original_Stock_Name)) AND ([Stock_ID] = @Original_Stock_ID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [STOCK] SET [Stock_Name] = @Stock_Name, [Stock_ID] = @Stock_ID WHERE (((@IsNull_Stock_Name = 1 AND [Stock_Name] IS NULL) OR ([Stock_Name] = @Original_Stock_Name)) AND ([Stock_ID] = @Original_Stock_ID));
SELECT Stock_Name, Stock_ID, CAST(Active AS INT) AS ActiveInt FROM STOCK WHERE (Stock_ID = @Stock_ID) ORDER BY Stock_Name, Stock_ID";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Stock_Name,\r\n       Stock_ID,\r\n       CAST([Active] AS INT) AS ActiveInt\r\n" +
                "FROM   STOCK\r\nORDER BY\r\n       Stock_Name,\r\n       Stock_ID";
        ...
        public virtual int Fill(dsSTOCK.STOCKDataTable dataTable) {
        ...
        public virtual dsSTOCK.STOCKDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsSTOCK.STOCKDataTable dataTable = new dsSTOCK.STOCKDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsSTOCK.STOCKDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Stock_Name, string Original_Stock_ID) {
            ...
            if ((Original_Stock_ID == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_Stock_ID));
            }
        ...
        public virtual int Update(string Stock_Name, string Stock_ID, string Original_Stock_Name, string Original_Stock_ID) {
            if ((Stock_Name == null)) {
            ...
            if ((Original_Stock_Name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_Stock_Name));
            }
            if ((Original_Stock_ID == null)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_Stock_ID));
            }
