...
{
    public class STOCK_OUTWARD : Object
    {
        #region Init
        ...
        {
            get { return "Class STOCK_OUTWARD"; }
        }
        ...
        {
            return SqlHelper.GenCode("STOCK_OUTWARD", "STOCK_OUTWARDID", key);
        }

        public string NewID(SqlTransaction myTransaction, string key)
        {
            return SqlHelper.GenCode(myTransaction, "STOCK_OUTWARD", "STOCK_OUTWARDID", key);
        }
        ...
        public string GetSale(string SaleID)
        {
            ...
            SqlDataReader myReader = mySql.ExecuteReader("STOCK_OUTWARD_GetSaleID", myPara, myValue);
            if (myReader != null)
            {
                while (myReader.Read())
                {
        ...
        public string GetLast(string CustomerID)
        {
            ...
            SqlDataReader myReader =
                mySql.ExecuteReader("Select * From [STOCK_OUTWARD] Where Customer_ID ='" + CustomerID +
                                    "' and Payment=0");
            if (myReader != null)
            {
                while (myReader.Read())
        ...
        public string GetSX(string Outward_ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            SqlDataReader myReader = mySql.ExecuteReader("STOCK_OUTWARD_GetSX", myPara, myValue);
            if (myReader != null)
            {
                while (myReader.Read())
                {
            ...
            string ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            SqlDataReader myReader = mySql.ExecuteReader(myConnection, "STOCK_OUTWARD_Get", myPara, myValue);
            if (myReader != null)
            {
            ...
            string ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            SqlDataReader myReader = mySql.ExecuteReader(myTransaction, "STOCK_OUTWARD_Get", myPara, myValue);
            if (myReader != null)
            {
                Result = myReader.HasRows;
                myReader.Close();
            ...
            bool Active)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myConnection, "STOCK_OUTWARD_Insert", myPara, myValue) == "OK" ? true : false;
        }
            ...
            bool Active)
        {
            ...
            var mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_Insert", myPara, myValue) == "OK" ? true : false;
        }
            ...
            bool Active)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myConnection, "STOCK_OUTWARD_Update", myPara, myValue) == "OK" ? true : false;
        }
            ...
            bool Active)
        {
            ...
            var mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_Update", myPara, myValue) == "OK" ? true : false;
        }
            ...
            bool Active)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myConnection, "STOCK_OUTWARD_UpdateByID", myPara, myValue) == "OK"
                       ? true
                       : false;
        }
            ...
            bool Active)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_UpdateByID", myPara, myValue) == "OK"
                       ? true
                       : false;
        }
            ...
            string ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myConnection, "STOCK_OUTWARD_Delete", myPara, myValue) == "OK" ? true : false;
        }
            ...
            string ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_Delete", myPara, myValue) == "OK" ? true : false;
        }
        ...
        public string DeleteSale(SqlTransaction myTransaction, string ID)
        {
            ...
            object[] myValue = {ID};
            SqlHelper mySql = new SqlHelper();
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_DeleteSale", myPara, myValue);
        }
        ...
        public string DeleteNo(SqlTransaction myTransaction, string Inward_ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            return mySql.ExecuteNonQuery(myTransaction, "STOCK_OUTWARD_DeleteNo", myPara, myValue);
        }
        ...
        public DataTable GetList()
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable("STOCK_OUTWARD_GetList");
        }
        ...
        public DataTable GetList(SqlConnection myConnection)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable(myConnection, "STOCK_OUTWARD_GetList");
        }
        ...
        public DataTable GetList(SqlTransaction myTransaction)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable(myTransaction, "STOCK_OUTWARD_GetList");
        }
        ...
        public DataTable GetList_ByDate(DateTime FromDate, DateTime ToDate, int Type)
        {
            ...
            return mysql.ExecuteDataTable("STOCK_OUTWARD_GetList_ByDate", myPara, myValue);
        }
        ...
        public DataTable GetList_ByDate_Action(DateTime FromDate, DateTime ToDate, int Type, int @Action)
        {
            ...
            return mysql.ExecuteDataTable("STOCK_OUTWARD_GetList_ByDate_Action", myPara, myValue);
        }
        ...
        public DataTable GetListSX(string id)
        {
            ...
            string[] myPara = {"@Outward_ID"};
            object[] myValue = {id};
            return mysql.ExecuteDataTable("STOCK_OUTWARD_GetSX", myPara, myValue);
        }
            ...
            SqlConnection myConnection)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteScalar(myConnection, "STOCK_OUTWARD_Count", 0);
        }
            ...
            SqlTransaction myTransaction)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteScalar(myTransaction, "STOCK_OUTWARD_Count", 0);
        }
            ...
            string Description)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable(myConnection, "STOCK_OUTWARD_Search", myPara, myValue);
        }
            ...
            string Description)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable(myTransaction, "STOCK_OUTWARD_Search", myPara, myValue);
        }
        ...
        public DataTable LookUp()
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable("STOCK_OUTWARD_LookUp");
        }
        ...
        public string ChangedInfo(string ID, DateTime RefDate, string Status, string CarNumber)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.CommandType = CommandType.Text;
            string sql = @"UPDATE STOCK_OUTWARD
	SET    RefDate = @RefDate,
		   Branch_ID = @CarNumber,
	       [Description] = @Status
	WHERE  ID = @ID
	...
	WHERE  RefType           = 2
	       AND RefID         = @ID";
            ...
            //return mySql.ExecuteNonQuery("STOCK_OUTWARD_UpdateInfo", myPara, myValue);
        ...
        public string PrintOptionInfoUpdate(string ID, string PrintOption)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            mySql.CommandType = CommandType.Text;
            string sql = @"UPDATE STOCK_OUTWARD SET Stock_ID = @PrintOption WHERE ID = @ID ";
            return mySql.ExecuteNonQuery(sql, myPara, myValue);
    ...
    public enum STOCK_OUTWARDFields
    {
        ID,
        RefDate,
        Ref_OrgNo,
    ...
    public class STOCK_OUTWARDCollection : System.Collections.CollectionBase
    {
        [Description("Adds a new STOCK_OUTWARD to the collection.")]
        public int Add(STOCK_OUTWARD item)
        {
            int newindex = List.Add(item);
            return newindex;
        }

        [Description("Removes a STOCK_OUTWARD from the collection.")]
        public void Remove(STOCK_OUTWARD item)
        {
            List.Remove(item);
        }

        [Description("Inserts an STOCK_OUTWARD into the collection at the specified index..")]
        public void Inserts(int index, STOCK_OUTWARD item)
        {
            List.Insert(index, item);
        }

        [Description("Returns the index value of the BRANCH class in the collection.")]
        public int IndexOf(STOCK_OUTWARD item)
        {
            return List.IndexOf(item);
        }

        [Description("Returns true if the STOCK_OUTWARD class is present in the collection.")]
        public bool Contains(STOCK_OUTWARD item)
        {
