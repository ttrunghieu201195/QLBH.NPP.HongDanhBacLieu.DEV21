...
namespace Perfect.Inventory.Report.Report
{
    ...
    public partial class rptStockOutwardA402 : XtraReport
    {
        System.Data.DataSet ds = null;
        string id;
        public rptStockOutwardA402(System.Data.DataSet dt, string ID, string title, string comment, decimal vatAmount, 
