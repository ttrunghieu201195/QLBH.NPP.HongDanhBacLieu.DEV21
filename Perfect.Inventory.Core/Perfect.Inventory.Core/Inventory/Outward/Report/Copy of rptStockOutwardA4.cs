...
namespace Perfect.Inventory.Report.Report
{
    ...
    public partial class rptStockOutwardA4 : XtraReport
    {
        ...
        string id;
        public rptStockOutwardA4(System.Data.DataSet dt, string ID, string title, string comment, decimal vatAmount, decimal totalAmount, decimal TotalDebt, string phone, decimal amount,decimal width)
        {
