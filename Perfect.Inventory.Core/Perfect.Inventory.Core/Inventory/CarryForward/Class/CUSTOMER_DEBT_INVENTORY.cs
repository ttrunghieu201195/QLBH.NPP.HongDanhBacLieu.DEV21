...
namespace Perfect.ERP
{
	...
	/// </summary>
	public class CUSTOMER_DEBT_INVENTORY:Object
	{
		#region Init
		private string m_ID;
		...
		public CUSTOMER_DEBT_INVENTORY()
		{
			//
        ...
        public DataTable GetListInit(string Customer_Group_ID)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteDataTable("CUSTOMER_DEBT_GetListInit", new string[] { "@Customer_Group_ID" }, new object[] { Customer_Group_ID });
        }
