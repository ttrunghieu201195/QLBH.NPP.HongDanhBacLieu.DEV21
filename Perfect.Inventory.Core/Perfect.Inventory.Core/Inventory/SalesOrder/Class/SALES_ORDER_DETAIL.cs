...
{
	public class SALES_ORDER_DETAIL:Object
	{
		#region Init
		private string m_ID;
		...
		public string Product
		{
			get
			{
				return "Class SALES_ORDER_DETAIL";
			}
		}
		...
		{
			return SqlHelper.GenCode("SALES_ORDER_DETAIL","SALES_ORDER_DETAILID",key);
		}

		public string NewID(SqlTransaction myTransaction, string key)
		{
			return SqlHelper.GenCode(myTransaction,"SALES_ORDER_DETAIL","SALES_ORDER_DETAILID",key);
		}
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
            SqlDataReader myReader = mySql.ExecuteReader(myConnection, "SALES_ORDER_DETAIL_Get", myPara, myValue);
			if (myReader !=null)
			{
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
            SqlDataReader myReader = mySql.ExecuteReader(myTransaction, "SALES_ORDER_DETAIL_Get", myPara, myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"SALES_ORDER_DETAIL_Insert",myPara,myValue)=="OK"?true:false;
		}
		public bool Insert(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"SALES_ORDER_DETAIL_Insert",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"SALES_ORDER_DETAIL_Update",myPara,myValue)=="OK"?true:false;
		}
		public bool Update(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"SALES_ORDER_DETAIL_Update",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"SALES_ORDER_DETAIL_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		public bool UpdateByID(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"SALES_ORDER_DETAIL_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			string ID)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"SALES_ORDER_DETAIL_Delete",myPara,myValue)=="OK"?true:false;
		}
		public bool Delete(
			SqlTransaction myTransaction,
			string ID)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"SALES_ORDER_DETAIL_Delete",myPara,myValue)=="OK"?true:false;
		}
		...
		public string Delete_XBB(SqlTransaction myTransaction, string Outward_Detail_ID)
        {
            ...
            SqlHelper mySql = new SqlHelper();
            return mySql.ExecuteNonQuery(myTransaction, "SALES_ORDER_DETAIL_Delete_XuatBaoBi", myPara, myValue);
        }
		#endregion
		...
		public DataTable GetList()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"SALES_ORDER_DETAIL_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"SALES_ORDER_DETAIL_GetList");
		}
		 ...
		 public DataTable GetList_ByOutward_ID(string Outward_ID)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList_ByID", myPara, myValue);
        }
         ...
         public DataTable GetList_ByOutward_ID(SqlTransaction myTransaction,string Outward_ID)
         {
             ...
             string[] myPara = { "@Outward_ID" };
             object[] myValue = { Outward_ID };
             return mysql.ExecuteDataTable(myTransaction,"SALES_ORDER_DETAIL_GetList_ByID", myPara, myValue);
         }
        ...
        public DataTable GetList_Merrial_ById(string Outward_Id)
        {
            ...
            string[] myPara = { "@Outward_ID" };
            object[] myValue = { Outward_Id };
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList_Merrial_ByID", myPara, myValue);
        }
        ...
        public DataTable GetList_ByDate(DateTime FromDate, DateTime ToDate, int Type)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList_ByDate", myPara, myValue);
        }
        ...
        public DataTable GetList_ByDate_Action(DateTime FromDate, DateTime ToDate, int Type,int Action)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList_ByDate_Action", myPara, myValue);
        }
        ...
        public DataTable ReportDate(DateTime FromDate, DateTime ToDate, string Stock,string Product)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_ReportDate", myPara, myValue);
        }
        public DataTable GetList_ByDate_Build(DateTime FromDate, DateTime ToDate, int Type)
        {
            ...
            string[] myPara ={ "@FromDate", "@ToDate", "@MoneyType" };
            object[] myValue ={ FromDate, ToDate, Type };
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetList_Date_Build", myPara, myValue);
        }
        public DataTable GetListIDSX(string Inward_ID)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetListIDSX", myPara, myValue);
        }
        public DataTable GetListSale(string SaleID)
        {
            ...
            return mysql.ExecuteDataTable("SALES_ORDER_DETAIL_GetListSale", myPara, myValue);
        }
			...
			SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myConnection,"SALES_ORDER_DETAIL_Count",0);
		}
			...
			SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myTransaction,"SALES_ORDER_DETAIL_Count",0);
		}
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"SALES_ORDER_DETAIL_Search",myPara,myValue);
		}
		#endregion
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"SALES_ORDER_DETAIL_Search",myPara,myValue);
		}
		#endregion
		...
		public DataTable LookUp()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("SALES_ORDER_DETAIL_LookUp");
		}
		#endregion
	...
	public enum SALES_ORDER_DETAILFields
		{
			ID,
			Outward_ID,
			Stock_ID,
	...
	public class SALES_ORDER_DETAILCollection : System.Collections.CollectionBase
		{
			[Description("Adds a new SALES_ORDER_DETAIL to the collection.")]
			public int Add(SALES_ORDER_DETAIL item)
				{
					int newindex = List.Add(item);
					return newindex;
				}
			[Description("Removes a SALES_ORDER_DETAIL from the collection.")]
			public void Remove(SALES_ORDER_DETAIL item)
				{
					List.Remove(item);
				}
			[Description("Inserts an SALES_ORDER_DETAIL into the collection at the specified index..")]
			public void Inserts(int index,SALES_ORDER_DETAIL item)
				{
					List.Insert(index,item);
				}
			[Description("Returns the index value of the BRANCH class in the collection.")]
			public int IndexOf(SALES_ORDER_DETAIL item)
				{
					return List.IndexOf(item);
				}
			[Description("Returns true if the SALES_ORDER_DETAIL class is present in the collection.")]
			public bool Contains(SALES_ORDER_DETAIL item)
				{
