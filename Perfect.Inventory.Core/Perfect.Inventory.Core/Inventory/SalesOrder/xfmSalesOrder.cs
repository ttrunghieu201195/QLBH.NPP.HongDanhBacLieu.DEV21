...
{
    public partial class xfmSalesOrder : xfmBase
    {
        private xucSalesOrder _ucOutwardB;
        //private xucSalesOrderList _xucOutwardListA;
        ...
        private void NiOutwardLinkClicked(object sender, NavBarLinkEventArgs e)
        {
            ...
            if (_ucOutwardB == null)
            {
                _ucOutwardB = new xucSalesOrder(EnumRefType.SalesOrder);
                _ucOutwardB.Add();
        ...
        private void NiOutwardListLinkClicked(object sender, NavBarLinkEventArgs e)
        {
            ...
            //{
            //    _xucOutwardListA = new xucSalesOrderList(ListType.General) { ListStyle = ListType.General };
