...
namespace Perfect.Inventory.Core.Inventory.Packet.DS {
    ...
    public partial class dsPRODUCT : global::System.Data.DataSet {
        ...
        public partial class PRODUCTDataTable : global::System.Data.TypedTableBase<PRODUCTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PRODUCTRow AddPRODUCTRow(string Product_ID, string Product_Name, decimal Quantity, decimal Org_Price, decimal Amount) {
...
namespace Perfect.Inventory.Core.Inventory.Packet.DS.dsPRODUCTTableAdapters {
    ...
    public partial class PRODUCTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Product_ID,
			  Product_Name,
			  Quantity,
			  CASE WHEN Org_Price IS NULL THEN 0 ELSE Org_Price END Org_Price,
			  Amount
...
FROM        
		(
			...
			SELECT
						b.Product_ID,
						b.Product_Name,
						CASE WHEN [a].[Quantity] IS NULL THEN 0 ELSE [a].[Quantity] END AS Quantity,
						CASE WHEN [a].[Quantity] =0 THEN 0 ELSE [a].[Amount]/[a].[Quantity] END AS Org_Price,
				...
				FROM
					(	
						...
						( SELECT   Product_ID, SUM(Quantity) AS Quantity, SUM(Amount) AS Amount
						 ...
						 WHERE   (Quantity <> 0)
						 GROUP BY Product_ID 
						 ) A FULL OUTER JOIN PRODUCT AS b ON a.Product_ID = b.Product_ID						   
					) 
					
				WHERE        (b.Active = 1)  AND (b.Product_Type_ID = @Product_Type_ID)
...
";
            ...
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Product_Type_ID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(dsPRODUCT.PRODUCTDataTable dataTable, global::System.Nullable<int> Product_Type_ID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Product_Type_ID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Product_Type_ID.Value));
            }
            else {
        ...
        public virtual dsPRODUCT.PRODUCTDataTable GetData(global::System.Nullable<int> Product_Type_ID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((Product_Type_ID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Product_Type_ID.Value));
            }
