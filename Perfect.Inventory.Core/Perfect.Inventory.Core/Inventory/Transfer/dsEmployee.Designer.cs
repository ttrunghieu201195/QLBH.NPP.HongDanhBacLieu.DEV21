...
namespace Perfect.Inventory.Core.Inventory.Transfer.dsEmployeeTableAdapters {
...
SELECT Employee_Name, Employee_ID FROM EMPLOYEE WHERE (Employee_ID = @Employee_ID) ORDER BY Employee_ID";
