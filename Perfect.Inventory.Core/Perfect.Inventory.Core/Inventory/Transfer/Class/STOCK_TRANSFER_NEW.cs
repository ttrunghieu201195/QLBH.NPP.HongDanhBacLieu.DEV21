...
namespace Perfect.ERP.Transfer
{
	/// <summary>
	/// Project: Perfect ERP System 
	/// Generated Class for Table : STOCK_TRANSFER.
	/// Date: 10/1/2012
	...
	public class STOCK_TRANSFER:Object
	{
		...
		{
			return SqlHelper.GenCode("STOCK_TRANSFER","STOCK_TRANSFERID",key);
		}

		public string NewID(SqlTransaction myTransaction, string key)
		{
			return SqlHelper.GenCode(myTransaction,"STOCK_TRANSFER","STOCK_TRANSFERID",key);
		}
			...
			bool Active)
		{
			...
			"@Description",
			"@Active"};
			object[] myValue={ID,RefDate,Ref_OrgNo,RefType,Department_ID,Employee_ID,FromStock_ID,Sender_ID,ToStock_ID,Receiver_ID,Branch_ID,Contract_ID,Currency_ID,ExchangeRate,Barcode,Amount,IsReview,User_ID,IsClose,Sorted,Description,Active};
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
