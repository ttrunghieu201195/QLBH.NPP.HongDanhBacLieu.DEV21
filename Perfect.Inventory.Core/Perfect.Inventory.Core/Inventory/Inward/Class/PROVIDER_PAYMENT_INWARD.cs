...
namespace Perfect.ERP
{
	...
	/// </summary>
	public class PROVIDER_PAYMENT_INWARD:Object
	{
		#region Init
		private Guid m_ID;
        ...
        public PROVIDER_PAYMENT_INWARD()
        {
            //
            ...
            m_RefType = 0;
            m_RefStatus = 0;
            m_PaymentMethod = new Guid("11111111-1111-1111-1111-111111111111");
            m_Barcode = "";
            m_CurrencyID = "";
            m_ExchangeRate = 0;
            m_BranchID = "";
		...
		public string Product
		{
			get
			{
                return "Class PROVIDER_PAYMENT_INWARD";
			}
		}
        ...
        public bool Get(Guid ID)
        {
            ...
            SqlDataReader myReader = mySql.ExecuteReader("PROVIDER_PAYMENT_Get", myPara, myValue);
            if (myReader != null)
            {
                while (myReader.Read())
                {
			...
			bool Active)
		{
			...
			return mySql.ExecuteNonQuery("PROVIDER_PAYMENT_Insert",myPara,myValue)=="OK"?true:false;
		}
		public bool Insert(
			SqlTransaction myTransaction,
			Guid ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery("PROVIDER_PAYMENT_Update",myPara,myValue)=="OK"?true:false;
		}
		public bool Update(
			SqlTransaction myTransaction,
			Guid ID,
        ...
        public bool UpdateRefStatus(SqlTransaction myTransaction, string inward)
        {
        ...
        public bool Delete(Guid ID)
        {
            ...
            var mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery("PROVIDER_PAYMENT_Delete", myPara, myValue) == "OK" ? true : false;
        }
