...
namespace Perfect.Dictionary.UI.UBarcode.DataSets {
...
namespace Perfect.Dictionary.UI.UBarcode.DataSets.dsPRODUCTTableAdapters {
    ...
    public partial class PRODUCTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [PRODUCT] SET [Product_ID] = @Product_ID, [Product_Name] = @Product_Name WHERE (([Product_ID] = @Original_Product_ID) AND ((@IsNull_Product_Name = 1 AND [Product_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)));
SELECT Product_ID, Product_Name FROM PRODUCT WHERE (Product_ID = @Product_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Perfect.Dictionary.Properties.Settings.Default.QLBH_Standard2_6ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Product_ID, Product_Name\r\nFROM            PRODUCT";
