...
namespace Perfect.Dictionary.Product.DS {
    ...
    public partial class dsSearch : global::System.Data.DataSet {
        ...
        public partial class PRODUCTDataTable : global::System.Data.TypedTableBase<PRODUCTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PRODUCTRow AddPRODUCTRow(bool Selected, string Product_ID, string Product_Name, decimal Quantity) {
...
namespace Perfect.Dictionary.Product.DS.dsSearchTableAdapters {
    ...
    public partial class PRODUCTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [PRODUCT] WHERE (((@IsNull_Product_ID = 1 AND [Product_ID] IS NULL) O" +
                "R ([Product_ID] = @Original_Product_ID)) AND ((@IsNull_Product_Name = 1 AND [Pro" +
                "duct_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [PRODUCT] SET [Product_ID] = @Product_ID, [Product_Name] = @Product_Name WHERE (((@IsNull_Product_ID = 1 AND [Product_ID] IS NULL) OR ([Product_ID] = @Original_Product_ID)) AND ((@IsNull_Product_Name = 1 AND [Product_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)));
SELECT CAST(0 AS bit) AS Selected, b.Product_ID, b.Product_Name, CASE WHEN [a].[SL] IS NULL THEN 0 ELSE [a].[SL] END AS Quantity FROM (SELECT Product_ID, SUM(Quantity) AS SL, SUM(Amount) AS TT FROM INVENTORY WHERE (Quantity <> 0) GROUP BY Product_ID) AS a FULL OUTER JOIN PRODUCT AS b ON a.Product_ID = b.Product_ID WHERE (a.Product_ID = @Product_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT    cast(0 as bit) as Selected,  b.Product_ID, b.Product_Name, CASE WHEN [a].[SL] IS NULL THEN 0 ELSE [a].[SL] END AS Quantity----, CASE WHEN [a].TT IS NULL 
                  ---    THEN 0 ELSE [a].TT END AS Amount

FROM         (SELECT     Product_ID, SUM(Quantity) AS SL, SUM(Amount) AS TT
                       FROM          INVENTORY
                       WHERE      (Quantity <> 0)
                       GROUP BY Product_ID) AS a FULL OUTER JOIN
...
";
        ...
        public virtual int Fill(dsSearch.PRODUCTDataTable dataTable) {
        ...
        public virtual dsSearch.PRODUCTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsSearch.PRODUCTDataTable dataTable = new dsSearch.PRODUCTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsSearch.PRODUCTDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Product_ID, string Original_Product_Name) {
        ...
        public virtual int Update(string Product_ID, string Product_Name, string Original_Product_ID, string Original_Product_Name) {
            if ((Product_ID == null)) {
