            ...
            public string Unit_ID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Unit_ID\' in table \'UNIT\' is DBNull.", e);
                    }
                }
                set {
...
namespace Perfect.Dictionary.Product._502.TS.DS.dsUnitTableAdapters {
    ...
    public partial class UNITTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [UNIT] WHERE (([Unit_ID] = @Original_Unit_ID) AND ((@IsNull_Unit_Name" +
                " = 1 AND [Unit_Name] IS NULL) OR ([Unit_Name] = @Original_Unit_Name)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [UNIT] ([Unit_ID], [Unit_Name]) VALUES (@Unit_ID, @Unit_Name);\r\nSELEC" +
                "T Unit_ID, Unit_Name FROM UNIT WHERE (Unit_ID = @Unit_ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [UNIT] SET [Unit_ID] = @Unit_ID, [Unit_Name] = @Unit_Name WHERE (([Unit_ID] = @Original_Unit_ID) AND ((@IsNull_Unit_Name = 1 AND [Unit_Name] IS NULL) OR ([Unit_Name] = @Original_Unit_Name)));
SELECT Unit_ID, Unit_Name FROM UNIT WHERE (Unit_ID = @Unit_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Perfect.Dictionary.Properties.Settings.Default.QLKConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Unit_ID, Unit_Name\r\nFROM            UNIT\r\nWHERE        (Active = 1)" +
                "";
        ...
        public virtual int Delete(string Original_Unit_ID, string Original_Unit_Name) {
        ...
        public virtual int Update(string Unit_ID, string Unit_Name, string Original_Unit_ID, string Original_Unit_Name) {
            if ((Unit_ID == null)) {
