...
namespace Perfect.Dictionary.Customer.usercontrol.DataSet.dsCUSTOMERSTableAdapters {
    ...
    public partial class CUSTOMERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [CUSTOMER] WHERE (([CustomerName] = @Original_CustomerName) AND ([Cus" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [CUSTOMER] SET [CustomerName] = @CustomerName, [Customer_ID] = @Customer_ID WHERE (([CustomerName] = @Original_CustomerName) AND ([Customer_ID] = @Original_Customer_ID));
SELECT CustomerName, Customer_ID FROM CUSTOMER WHERE (Customer_ID = @Customer_ID)";
