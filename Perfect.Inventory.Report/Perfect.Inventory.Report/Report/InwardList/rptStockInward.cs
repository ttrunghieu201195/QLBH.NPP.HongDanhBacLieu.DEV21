...
{
    public partial class rptStockInward : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockInward(DataTable dt, string ID,string Title,string Date ,string CustomerName, string CustomerAddress, string StockName, string Reason)
        {
            InitializeComponent();
            if (dt != null)
            {
            ...
            //    {
            //        cf.Insert(Guid.NewGuid().ToString(), "rptStockInward", PageHeader.Controls[i].Name, "EN", PageHeader.Controls[i].Text, "", true);
            //    }
            //}
            ...
            //    {
            //        cf.Insert(Guid.NewGuid().ToString(), "rptStockInward", xrTableRow1.Controls[i].Name, "EN", xrTableRow1.Controls[i].Text, "", true);
            //    }
            //}
            ...
            //    {
            //        cf.Insert(Guid.NewGuid().ToString(), "rptStockInward", PageFooter.Controls[i].Name, "EN", PageFooter.Controls[i].Text, "", true);
            //    }
            //}

            //CONTROL_FORMAT.Save("rptStockInward", "EN");


            //DataTable tb = CONTROL_FORMAT.Load("rptStockInward");
            //if (tb != null)
