...
{
    public partial class rptCustomerProduct : XtraReport
    {
        int Count = 0;
        public rptCustomerProduct()
        {
            InitializeComponent();
        ...
        public rptCustomerProduct(string id, DataTable dt, string title, string comment, string filterstring)
        {
            InitializeComponent();
            //PrintingSystem.PreviewRibbonFormEx.RibbonControl.ShowPageHeadersMode =
            //    DevExpress.XtraBars.Ribbon.ShowPageHeadersMode.Hide;
