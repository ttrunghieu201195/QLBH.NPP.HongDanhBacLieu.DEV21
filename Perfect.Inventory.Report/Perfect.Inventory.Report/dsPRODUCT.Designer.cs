...
namespace Perfect.Inventory.Report.dsPRODUCTTableAdapters {
    ...
    public partial class PRODUCTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PRODUCT] SET [Product_ID] = @Product_ID, [Product_Name] = @Product_Name WHERE (([Product_ID] = @Original_Product_ID) AND ((@IsNull_Product_Name = 1 AND [Product_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)));
SELECT Product_ID, Product_Name FROM PRODUCT WHERE (Product_ID = @Product_ID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Product_Name, string Original_Product_ID, string Original_Product_Name) {
