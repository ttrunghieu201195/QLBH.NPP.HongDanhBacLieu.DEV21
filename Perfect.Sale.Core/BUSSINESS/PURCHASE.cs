...
namespace Perfect.ERP
{
	...
	public class PURCHASE:Object
	{
		...
		private bool m_IsInward;
		private bool m_IsReceived;
		private bool m_IsClosed;
		private bool m_IsFob;
		...
		{
			return SqlHelper.GenCode("PURCHASE","PURCHASEID",key);
		}

		public string NewID(SqlTransaction myTransaction, string key)
		{
			return SqlHelper.GenCode(myTransaction,"PURCHASE","PURCHASEID",key);
		}
			...
			string ID)
		{
			...
			SqlDataReader myReader=mySql.ExecuteReader(myConnection,"PURCHASE_Get",myPara,myValue);
			if (myReader !=null)
			{
			...
			string ID)
		{
			...
			ID};
			var mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myTransaction,"PURCHASE_Get",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
		...
		public bool ExistByID(SqlTransaction myTransaction,string ID)
		{
			...
			object[] myValue={ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myTransaction,"PURCHASE_ExistByID",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			string ID)
		{
			...
			object[] myValue={ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myConnection,"PURCHASE_ExistByID",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			string ID)
		{
			...
			if (myReader !=null)
			{
				while (myReader.Read())
				{
						...
						m_IsInward =Convert.ToBoolean(myReader["IsInward"]==DBNull.Value?true:myReader["IsInward"] );
						...
						m_IsFob =Convert.ToBoolean(myReader["IsFob"]==DBNull.Value?true:myReader["IsFob"] );
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_Insert",myPara,myValue)=="OK"?true:false;
		}
		public bool Insert(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_Insert",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_Update",myPara,myValue)=="OK"?true:false;
		}
		public bool Update(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		public bool UpdateByID(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_Delete",myPara,myValue)=="OK"?true:false;
		}
		public bool Delete(
			SqlTransaction myTransaction,
			string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_Delete",myPara,myValue)=="OK"?true:false;
		}
		#endregion
		...
		public DataTable GetList()
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PURCHASE_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlConnection myConnection)
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PURCHASE_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlTransaction myTransaction)
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PURCHASE_GetList");
		}
		#endregion
			...
			SqlConnection myConnection)
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myConnection,"PURCHASE_Count",0);
		}
			...
			SqlTransaction myTransaction)
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myTransaction,"PURCHASE_Count",0);
		}
			...
			string Description)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PURCHASE_Search",myPara,myValue);
		}
		#endregion
			...
			string Description)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PURCHASE_Search",myPara,myValue);
		}
		#endregion
		...
		public DataTable LookUp()
		{
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PURCHASE_LookUp");
		}
		#endregion
	...
	public class PURCHASECollection : System.Collections.CollectionBase
		{
			[Description("Adds a new PURCHASE to the collection.")]
			public int Add(PURCHASE item)
				{
					int newindex = List.Add(item);
					return newindex;
				}
			[Description("Removes a PURCHASE from the collection.")]
			public void Remove(PURCHASE item)
				{
					List.Remove(item);
				}
			[Description("Inserts an PURCHASE into the collection at the specified index..")]
			public void Inserts(int index,PURCHASE item)
				{
			...
			[Description("Returns true if the PURCHASE class is present in the collection.")]
