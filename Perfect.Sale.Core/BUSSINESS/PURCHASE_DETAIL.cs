...
namespace Perfect.ERP
{
	...
	/// Generated Class for Table : PURCHASE_DETAIL.
	/// Date: 08/03/2010
	/// Author: Trần Hoàng Tâm
	/// </summary>
	public class PURCHASE_DETAIL:Object
	{
		#region Init
		private string m_ID;
		...
		{
			return SqlHelper.GenCode("PURCHASE_DETAIL","PURCHASE_DETAILID",key);
		}

		public string NewID(SqlTransaction myTransaction, string key)
		{
			return SqlHelper.GenCode(myTransaction,"PURCHASE_DETAIL","PURCHASE_DETAILID",key);
		}
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myConnection,"PURCHASE_DETAIL_Get",myPara,myValue);
			if (myReader !=null)
			{
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myTransaction,"PURCHASE_DETAIL_Get",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			string ID)
		{
			...
			if (myReader !=null)
			{
				while (myReader.Read())
				{
						...
						m_PurchaseID =Convert.ToString(myReader["PurchaseID"]);
						...
						m_PurchaseID =Convert.ToString(myReader["PurchaseID"]==DBNull.Value?"":myReader["PurchaseID"] );
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_DETAIL_Insert",myPara,myValue)=="OK"?true:false;
		}
		public bool Insert(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
            ...
            mySql.Error += DispError; //PURCHASE_DETAIL_Insert
            return mySql.ExecuteNonQuery(myTransaction, "PURCHASE_DETAIL_Insert", myPara, myValue) == "OK" ? true : false;
		}
		#endregion
			...
			bool Active)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_DETAIL_Update",myPara,myValue)=="OK"?true:false;
		}
		public bool Update(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			"@Description",
			"@Active"};
			object[] myValue={ID,PurchaseID,StockID,RefType,ProductID,ProductName,Unit,UnitConvert,Thung,Met,Vien,Vat,VatAmount,Shipped,CurrentQty,Quantity,UnitPrice,Amount,QtyConvert,DiscountRate,Discount,Charge,FDiscount,FCharge,FAmount,Limit,Guarantee,Width,Height,Batch,Serial,ChassyNo,IME,Orgin,Size,Color,Sorted,StoreID,Description,Active};
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_DETAIL_Update",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_DETAIL_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		public bool UpdateByID(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_DETAIL_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PURCHASE_DETAIL_Delete",myPara,myValue)=="OK"?true:false;
		}
		public bool Delete(
			SqlTransaction myTransaction,
			string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PURCHASE_DETAIL_Delete",myPara,myValue)=="OK"?true:false;
		}
		#endregion
		...
		public DataTable GetList()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PURCHASE_DETAIL_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PURCHASE_DETAIL_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PURCHASE_DETAIL_GetList");
		}
		#endregion
			...
			SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myConnection,"PURCHASE_DETAIL_Count",0);
		}
			...
			SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myTransaction,"PURCHASE_DETAIL_Count",0);
		}
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PURCHASE_DETAIL_Search",myPara,myValue);
		}
		#endregion
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PURCHASE_DETAIL_Search",myPara,myValue);
		}
		#endregion
		...
		public DataTable LookUp()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PURCHASE_DETAIL_LookUp");
		}
		#endregion
	...
	public enum PURCHASE_DETAILFields
		{
			ID,
			PurchaseID,
			StockID,
	...
	public class PURCHASE_DETAILCollection : System.Collections.CollectionBase
		{
			[Description("Adds a new PURCHASE_DETAIL to the collection.")]
			public int Add(PURCHASE_DETAIL item)
				{
					int newindex = List.Add(item);
					return newindex;
				}
			[Description("Removes a PURCHASE_DETAIL from the collection.")]
			public void Remove(PURCHASE_DETAIL item)
				{
					List.Remove(item);
				}
			[Description("Inserts an PURCHASE_DETAIL into the collection at the specified index..")]
			public void Inserts(int index,PURCHASE_DETAIL item)
				{
					List.Insert(index,item);
				}
			[Description("Returns the index value of the BRANCH class in the collection.")]
			public int IndexOf(PURCHASE_DETAIL item)
				{
					return List.IndexOf(item);
				}
			[Description("Returns true if the PURCHASE_DETAIL class is present in the collection.")]
			public bool Contains(PURCHASE_DETAIL item)
				{
