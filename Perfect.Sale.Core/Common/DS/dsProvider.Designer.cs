...
namespace Perfect.Sale.Core.Common.DS {
    ...
    public partial class dsProvider : global::System.Data.DataSet {
        ...
        public partial class PROVIDERDataTable : global::System.Data.TypedTableBase<PROVIDERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PROVIDERRow AddPROVIDERRow(string Customer_ID, string CustomerName) {
        ...
        public partial class PROVIDERRow : global::System.Data.DataRow {
            ...
            public string Customer_ID {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Customer_ID\' in table \'PROVIDER\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsCustomer_IDNull() {
                return this.IsNull(this.tablePROVIDER.Customer_IDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetCustomer_IDNull() {
                this[this.tablePROVIDER.Customer_IDColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Perfect.Sale.Core.Common.DS.dsProviderTableAdapters {
    ...
    public partial class PROVIDERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [PROVIDER] WHERE (([Customer_ID] = @Original_Customer_ID) AND ([Custo" +
                "merName] = @Original_CustomerName))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [PROVIDER] SET [Customer_ID] = @Customer_ID, [CustomerName] = @CustomerName WHERE (([Customer_ID] = @Original_Customer_ID) AND ([CustomerName] = @Original_CustomerName));
SELECT Customer_ID, CustomerName FROM PROVIDER WHERE (Customer_ID = @Customer_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Customer_ID, CustomerName\r\nFROM            PROVIDER\r\nWHERE        (" +
                "Active = 1)";
        ...
        public virtual int Delete(string Original_Customer_ID, string Original_CustomerName) {
        ...
        public virtual int Update(string Customer_ID, string CustomerName, string Original_Customer_ID, string Original_CustomerName) {
            if ((Customer_ID == null)) {
