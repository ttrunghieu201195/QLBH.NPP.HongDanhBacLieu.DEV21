...
namespace Perfect.Sale.Core.Common.DS {
    ...
    public partial class dsStock : global::System.Data.DataSet {
        ...
        public partial class STOCKDataTable : global::System.Data.TypedTableBase<STOCKRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public STOCKRow AddSTOCKRow(string Stock_ID, string Stock_Name) {
...
namespace Perfect.Sale.Core.Common.DS.dsStockTableAdapters {
    ...
    public partial class STOCKTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [STOCK] WHERE (([Stock_ID] = @Original_Stock_ID) AND ((@IsNull_Stock_" +
                "Name = 1 AND [Stock_Name] IS NULL) OR ([Stock_Name] = @Original_Stock_Name)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [STOCK] SET [Stock_ID] = @Stock_ID, [Stock_Name] = @Stock_Name WHERE (([Stock_ID] = @Original_Stock_ID) AND ((@IsNull_Stock_Name = 1 AND [Stock_Name] IS NULL) OR ([Stock_Name] = @Original_Stock_Name)));
SELECT Stock_ID, Stock_Name FROM STOCK WHERE (Stock_ID = @Stock_ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Stock_ID, Stock_Name\r\nFROM            STOCK\r\nWHERE        (Active =" +
                " 1)";
        ...
        public virtual int Delete(string Original_Stock_ID, string Original_Stock_Name) {
        ...
        public virtual int Update(string Stock_ID, string Stock_Name, string Original_Stock_ID, string Original_Stock_Name) {
            if ((Stock_ID == null)) {
            ...
            if ((Original_Stock_ID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_Stock_ID));
            }
            if ((Original_Stock_Name == null)) {
