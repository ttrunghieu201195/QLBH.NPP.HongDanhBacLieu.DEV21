...
namespace Perfect.ERP
{
	...
	/// Generated Class for Table : CUSTOMER_DEBT.
	/// Date: 17/03/2010
	/// Author: Trần Hoàng Tâm
	/// </summary>
	public class CUSTOMER_DEBT:Object
	{
		#region Init
		private string m_ID;
        ...
        public DataTable GetListInit(string Customer_Group_ID)
        {
            SqlHelper mySql = new SqlHelper();
            mySql.Error += DispError;
...
WHERE  A.Customer_Group_ID = @Customer_Group_ID
       OR  1 = CASE 
            ...
            return mySql.ExecuteDataTable(query, new string[] { "@Customer_Group_ID" }, new object[] { Customer_Group_ID });
        }
