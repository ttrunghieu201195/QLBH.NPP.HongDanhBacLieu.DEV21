...
namespace Perfect.ERP
{
	...
	/// Generated Class for Table : PROVIDER_PAYMENT.
	/// Date: 16/03/2010
	/// Author: Trần Hoàng Tâm
	/// </summary>
	public class PROVIDER_PAYMENT:Object
	{
		#region Init
		private string m_ID;
		...
		{
			return SqlHelper.GenCode("PROVIDER_PAYMENT","RefID",key);
		}

		public string NewID(SqlTransaction myTransaction, string key)
		{
			return SqlHelper.GenCode(myTransaction,"PROVIDER_PAYMENT","PROVIDER_PAYMENTID",key);
		}
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myConnection,"PROVIDER_PAYMENT_Get",myPara,myValue);
			if (myReader !=null)
			{
			...
			string ID)
		{
			...
			ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myTransaction,"PROVIDER_PAYMENT_Get",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
		...
		public bool ExistByID(SqlTransaction myTransaction,string ID)
		{
			...
			object[] myValue={ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myTransaction,"PROVIDER_PAYMENT_ExistByID",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			string ID)
		{
			...
			object[] myValue={ID};
			SqlHelper mySql=new SqlHelper();
			SqlDataReader myReader=mySql.ExecuteReader(myConnection,"PROVIDER_PAYMENT_ExistByID",myPara,myValue);
			if (myReader !=null)
			{
					Result= myReader.HasRows;
				myReader.Close();
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PROVIDER_PAYMENT_Insert",myPara,myValue)=="OK"?true:false;
		}
		public bool Insert(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PROVIDER_PAYMENT_Insert",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PROVIDER_PAYMENT_Update",myPara,myValue)=="OK"?true:false;
		}
		public bool Update(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PROVIDER_PAYMENT_Update",myPara,myValue)=="OK"?true:false;
		}
		#endregion
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PROVIDER_PAYMENT_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		public bool UpdateByID(
			SqlTransaction myTransaction,
			string ID,
			...
			bool Active)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PROVIDER_PAYMENT_UpdateByID",myPara,myValue)=="OK"?true:false;
		}
		#endregion
        ...
        public bool Delete2011(string ID, string refOrgNo)
        {
            var mySql = new SqlHelper();
            mySql.Error += DispError;
            if (mySql.Open() != "OK") return false;
            if (Delete2011(mySql.Connection, ID,refOrgNo))
            {
                mySql.Close();
                return true;
            };
		...
		public bool Delete(SqlConnection myConnection,string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myConnection,"PROVIDER_PAYMENT_Delete",myPara,myValue)=="OK"?true:false;
		}
        public bool Delete2011(SqlConnection myConnection, string ID, string RefOrgNo)
        {
            ...
            var mySql = new SqlHelper();
            mySql.Error += DispError;
            return mySql.ExecuteNonQuery(myConnection, "PROVIDER_PAYMENT_Delete2011", myPara, myValue) == "OK" ? true : false;
        }
		public bool Delete(
			SqlTransaction myTransaction,
			string ID)
		{
			...
			var mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteNonQuery(myTransaction,"PROVIDER_PAYMENT_Delete",myPara,myValue)=="OK"?true:false;
		}
		#endregion
		...
		public DataTable GetList()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PROVIDER_PAYMENT_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PROVIDER_PAYMENT_GetList");
		}
		#endregion
		...
		public DataTable GetList(SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PROVIDER_PAYMENT_GetList");
		}
		#endregion
			...
			SqlConnection myConnection)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myConnection,"PROVIDER_PAYMENT_Count",0);
		}
			...
			SqlTransaction myTransaction)
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteScalar(myTransaction,"PROVIDER_PAYMENT_Count",0);
		}
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myConnection,"PROVIDER_PAYMENT_Search",myPara,myValue);
		}
		#endregion
			...
			string Description)
		{
			...
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable(myTransaction,"PROVIDER_PAYMENT_Search",myPara,myValue);
		}
		#endregion
		...
		public DataTable LookUp()
		{
			SqlHelper mySql=new SqlHelper();
			mySql.Error += DispError;
			return mySql.ExecuteDataTable("PROVIDER_PAYMENT_LookUp");
		}
		#endregion
	...
	public enum PROVIDER_PAYMENTFields
		{
			ID,
			RefID,
			RefDate,
	...
	public class PROVIDER_PAYMENTCollection : System.Collections.CollectionBase
		{
			[Description("Adds a new PROVIDER_PAYMENT to the collection.")]
			public int Add(PROVIDER_PAYMENT item)
				{
					int newindex = List.Add(item);
					return newindex;
				}
			[Description("Removes a PROVIDER_PAYMENT from the collection.")]
			public void Remove(PROVIDER_PAYMENT item)
				{
					List.Remove(item);
				}
			[Description("Inserts an PROVIDER_PAYMENT into the collection at the specified index..")]
			public void Inserts(int index,PROVIDER_PAYMENT item)
				{
					List.Insert(index,item);
				}
			[Description("Returns the index value of the BRANCH class in the collection.")]
			public int IndexOf(PROVIDER_PAYMENT item)
				{
					return List.IndexOf(item);
				}
			[Description("Returns true if the PROVIDER_PAYMENT class is present in the collection.")]
			public bool Contains(PROVIDER_PAYMENT item)
				{
